...
\begin{DoxyCompactList}\small\item\em \-This routine calculates the sum of elements of a vector. \end{DoxyCompactList}\end{DoxyCompactItemize}
...
#pragma GCC diagnostic ignored "-Wconversion"
         ...
         */
        if (l->match[c] > 0)
            l->intermediate[c] = log_c->logNotC[c] * (LogProbability) l->match[
      c];
        else
            l->intermediate[c] = 0.;
...
\-Definition at line 304 of file measurement.\-c.
